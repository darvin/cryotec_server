...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('actions_report', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reporttemplate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actiontemplates.ReportTemplate'], null=True, blank=True)),
            ('maintenance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actions.Maintenance'], null=True, blank=True)),
