...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.reporttemplate'
        db.add_column('actions_report', 'reporttemplate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actions.ReportTemplate'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Report.reporttemplate'
        db.delete_column('actions_report', 'reporttemplate_id')
    ...
    models = {
        ...
        'actions.report': {
            ...
            'reporttemplate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['actions.ReportTemplate']", 'null': 'True', 'blank': 'True'})
        },
