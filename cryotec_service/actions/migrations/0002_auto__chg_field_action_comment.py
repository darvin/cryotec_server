...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('actions_action', 'comment', self.gf('django.db.models.fields.TextField')(max_length=3000))


    def backwards(self, orm):
        
        # Changing field 'Action.comment'
        db.alter_column('actions_action', 'comment', self.gf('django.db.models.fields.CharField')(max_length=3000))
