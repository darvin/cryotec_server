...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('machines_machine', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='machines_customer', null=True, to=orm['clients.Client'], blank=True), keep_default=False)
