...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('checklists_checklistanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('checklistquestion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checklists.ChecklistQuestion'])),
            ('paction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actions.PAction'])),
